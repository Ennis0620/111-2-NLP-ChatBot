...
from model.model_bert_2 import Seq2Seq
import numpy as np
import tqdm
...
if __name__ =='__main__':
    ...
    WEIGHTS = f'{CURRENT_PATH}/weights/model_bert_2_GRU_emd100/{WEIGHTS_NAME}'


    SAVE_MODELS_PATH = f'{CURRENT_PATH}/weights/model_bert_2_GRU_emd100/'
